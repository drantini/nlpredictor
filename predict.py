...
def populate_matchup_data(matchup):
    ...
    team_left_exits = exits[exits['Team'] == team1_name]
    team_left_exits = team_left_exits['ControlledExits %'].mean()
    team_right_exits = exits[exits['Team'] == team2_name]
    ...
    team_left_entries = entries[entries['Team'] == team1_name]
    team_left_entries = team_left_entries['ControlledEntries %'].mean()
    team_right_entries = entries[entries['Team'] == team2_name]
    ...
    team_left_exits_denial = exits_denial[exits_denial['Team'] == team1_name]
    team_left_exits_denial = team_left_exits_denial['ControlledExits %against'].mean()
    team_right_exits_denial = exits_denial[exits_denial['Team'] == team2_name]
    ...
    team_left_entries_denial = entries_denial[entries_denial['Team'] == team1_name]
    team_left_entries_denial = team_left_entries_denial['ControlledEntries %against'].mean()
    team_right_entries_denial = entries_denial[entries_denial['Team'] == team2_name]
